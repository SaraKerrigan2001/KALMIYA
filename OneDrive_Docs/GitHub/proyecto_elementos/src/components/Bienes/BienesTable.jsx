...
import '../../assets/css/BienesTable.css'
      ...
      <div className="bienes-table-wrapper">
        <table className="bienes-table">
          <thead className="bienes-table-head">
            <tr>
              <th className="bienes-table-th">{t('bienes.modelo')}</th>
              <th className="bienes-table-th">{t('bienes.descripcion')}</th>
              <th className="bienes-table-th">{t('bienes.serial')}</th>
              <th className="bienes-table-th">{t('bienes.estado')}</th>
              <th className="bienes-table-th">{t('bienes.costo')}</th>
              <th className="bienes-table-th">{t('bienes.fechaCompra')}</th>
              <th className="bienes-table-th">{t('bienes.vidaUtil')}</th>
              <th className="bienes-table-th">{t('bienes.sede')}</th>
          ...
          <tbody className="bienes-table-body">
            {filteredBienes.length === 0 ? (
              <tr>
                <td colSpan="9" className="bienes-empty-state">
              ...
              filteredBienes.map((bien) => (
                <tr key={bien.id} className="bienes-table-row">
                  ...
                  <td className="bienes-table-td bienes-table-td-vida-util">
                    {bien.vidaUtil ? `${bien.vidaUtil} años` : '-'}
                  </td>
