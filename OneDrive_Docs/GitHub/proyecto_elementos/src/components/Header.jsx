...
const Header = ({ onMenuClick, activeView = 'dashboard' }) => {
  ...
  const getPageTitle = () => {
    switch (activeView) {
      case 'dashboard':
        return t('header.dashboardPrincipal')
      case 'bienes':
        return t('bienes.titulo')
      case 'cuentadantes':
        return t('cuentadantes.titulo')
      case 'asignaciones':
        return t('asignaciones.titulo')
      default:
        return t('header.dashboardPrincipal')
    }
  }
